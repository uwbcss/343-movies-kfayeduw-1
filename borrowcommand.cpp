...
void BorrowCommand::init(string data) {
...
void BorrowCommand::execute() {
  ...
  c->borrowItem(m, this->mediaType);
}

BorrowCommandFactory::BorrowCommandFactory() { registerType('B', this); }

Command *BorrowCommandFactory::makeCommand() const {
